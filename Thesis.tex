...
%% Publisher’s logo
\newcommand*{\ulogo}{\includegraphics[width=0.5\textwidth]{UONlogo}}
...
%
%The support of my family and friends has been my backbone through this process. To my mum and dad especially, who have always encouraged me and fostered my love of learning, I can't thank you enough and I hope this achievement helps convince you of the amazing parents that you are to all of your children. 
%
...
\newpage
\include{Chapter1_Introduction/Chapter_Intro}
...
\newpage
\include{Chapter2_SysIDandControl/Chapter_SysIDandControl}
...
\newpage
\include{Chapter3_VolterraSeries/Chapter_VolterraSeries}
...
\newpage
\include{Chapter4_EM/Chapter_EM}
...
\newpage
\include{Chapter5_RegBFs/Chapter_RegBFs}
...
\newpage
\include{Chapter6_CaseStudies/Chapter_CaseStudies}
...
\newpage
\include{Chapter7_NOFRFs/Chapter_NOFRFs}
...
\newpage
\include{Chapter8_GFRFs/Chapter_GFRFs}
...
\newpage
\include{Chapter9_NonlinTransients/Chapter_NonlinTransients}
...
\newpage
\include{Chapter10_NMPC/Chapter_NMPC}
...
\newpage
\include{Chapter11_ControlStudy/Chapter_ControlStudy}
...
\newpage
\include{Chapter12_Conclusion/Chapter_Conclusion}
